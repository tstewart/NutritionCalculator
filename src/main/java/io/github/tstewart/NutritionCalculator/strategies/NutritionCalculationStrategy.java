...
public class NutritionCalculationStrategy implements UserNutrition.UserNutritionCalculation {
     ...
     *
     * These values are then multiplied by 1.2, assuming a normal amount of exercise by the user.
     *
    ...
    public UserNutrition calculateNutritionalInformation(UserInfo info) {
        ...
        calorieCalculation *= 1.2;
        nutrition.setCaloriesRequired((int) Math.floor(calorieCalculation));
        return nutrition;
    }
